...
/***/ (function(module, exports, __webpack_require__) {
	...
	var goalEvents = __webpack_require__(35);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://icarpediem.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var goalapi = __webpack_require__(13);
	var goalui = __webpack_require__(14);
	var goalevents = __webpack_require__(35);
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  $('#signinmodal').modal('toggle');
	  goalapi.getGoals().then(goalui.getGoalsSuccess).catch(goalui.getGoalsFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateGoal = function updateGoal(goalId, data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showGoalsTemplate = __webpack_require__(15);
	...
	var getGoalsFailure = function getGoalsFailure() {};
	...
	module.exports = {
	  ...
	  getGoalsFailure: getGoalsFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <ul class=\"list-unstyled\"><li data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Status: "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.status : stack1), depth0))
	    + "</li>\n        <li>\n          <button type=\"button\" class=\"update btn btn-primary handle\" data-toggle=\"modal\" data-target=\"#updategoalmodal"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Item</button>\n          <button type=\"button\" class=\"remove btn btn-default handle\" data-toggle=\"modal\" data-target=\"#removegoalmodal"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove Item</button>\n        </li>\n      </ul>\n      <div class=\"modal fade\" id=\"updategoalmodal"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Update Bucket List Item</h5>\n            </div>\n            <div class=\"modal-body\">\n              <p>Current Item Summary<br>\n                 Description: "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.description : stack1), depth0))
	    + "<br>\n                 Category: "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.category : stack1), depth0))
	    + "<br>\n                 Status: "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.status : stack1), depth0))
	    + "<br>\n               </p>\n               <p>*You must fill in all fields in order to update a list item</p>\n              <form class=\"update-goal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n              <fieldset>\n                <input type='text' name='goal[description]' id ='updateDescription' placeholder=\"Updated Description\">\n                <input type='text' name='goal[category]' id ='updateCategory' placeholder=\"Updated Category\">\n                <input type='text' name='goal[status]' id ='updateStatus' placeholder=\"Updated Status\">\n                <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Update List Item\">\n            </fieldset>\n            </form>\n            </div>\n            <div class=\"modal-footer\">\n              <div class=\"updateerror\"></div>\n              <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <div class=\"modal fade\" id=\"removegoalmodal"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Are you sure you want to remove item?</h5>\n            </div>\n            <div class=\"modal-body\">\n              <form class=\"remove-goal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                <fieldset>\n                  <legend>"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.description : stack1), depth0))
	    + "</legend>\n                  <input type=\"submit\" name=\"submit\" value=\"Remove List Item\">\n                </fieldset>\n              </form>\n            </div>\n            <div class=\"modal-footer\">\n              <div class=\"passworderror\"></div>\n              <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n            </div>\n          </div>\n        </div>\n      </div>\n\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "      No description.\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.goals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateGoal = function onCreateGoal(event) {
	  ...
	  if (checkForBlanks(data)) {
	    ...
	    api.createGoal(data).done(ui.createGoalSuccess, getGoals).catch(ui.createGoalFailure);
	  }
	};
	...
	var onGetGoals = function onGetGoals(event) {
	  ...
	  api.getGoals().then(ui.getGoalsSuccess).catch(ui.getGoalsFailure);
	};

	var onDeleteGoal = function onDeleteGoal() {
	  // prevent screen from refreshing
	  event.preventDefault();
	  ...
	  api.deleteGoal(data).done(ui.deleteGoalSuccess, getGoals).catch(ui.deleteGoalFailure);
	};
	...
	var onUpdateGoal = function onUpdateGoal(event) {
	  ...
	  if (checkForBlanks(data)) {
	    ...
	    api.updateGoal(goalId, data).done(ui.updateGoalSuccess, getGoals).catch(ui.updateGoalFailure);
	  }
	};

	var goalHandlers = function goalHandlers() {
